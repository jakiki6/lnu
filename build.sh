...
download libgpg-error.tat.bz2 "https://www.gnupg.org/ftp/gcrypt/libgpg-error/libgpg-error-1.45.tar.bz2"
...
download linux.tar.gz "https://cdn.kernel.org/pub/linux/kernel/v6.x/linux-6.2.9.tar.xz"
...
if [ ! -d kexec ]; then
    ...
    tar vfx ../dist/kexec.tar.gz --strip-components=1
